  ...
  <div id="hello" style="width:100%;background:white;padding-top:0.133333rem;">
     <!--没有课程时展示--> 
       <div v-if="true" class="mei_box">
       	   <img src="../../../static/img/xiaoxingxing.png" alt="" />
       	   <div class="p_boxa">暂时没发现收藏哦~去首页看看有什么课程吧</div>
       	   ...
       	   <div class="value_box_c">
       	   	  ...
       	   	  <div id="img_box">
       	   	   ...
       	   	   <div class="box_right">
       	   	   	 ...
       	   	   	 <div class="title_d">
       	   	   	 	<img src="../../../static/img/lisi.png" alt=""/><p>{{i.created_at}}</p> 
       	   	   	 	<div @click="go_ac(i)" class="btns">查看详情</div> 		
       	   	   	 </div>
       	   	   </div>
       	   </div>
       </div>
  ...
  methods:{
  	  ...
  	  git_act(){
  	  	  const loading = this.$loading({
  	 	    ...
  	 	    axios.get(store.state.urls+'api/collect/index?token='+localStorage.api_token1
        	      ).then(res=>{
        	      	 if(res.data.code==200){
        	      	 	  console.log(res.data.data.data,'收藏数据');
